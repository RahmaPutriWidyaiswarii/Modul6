@php
// mengembalikan nama rute dari rute yang sedang aktif.
    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            ...
            <ul class="navbar-nav flex-row flex-wrap">
                {{-- rute untuk ke halaman utama (home). setelah itu mengecek apakah nama rute saat ini adalah 'home', dan jika iya, maka kelas CSS 'active' akan ditambahkna --}}
